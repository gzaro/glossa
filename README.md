...
7.1.5 Γράψε ένα πρόγραμμα που δέχεται έναν ακέραιο από το πληκτρολόγιο και εμφανίζει τη θέση που βρίσκεται στον παρακάτω πίνακα.
...
7.1.6 Τρέξε το προηγούμενο πρόγραμμα που έφτιαξες, δίνοντας τον αριθμό 81. Πόσους ελέγχους ισότητας εκτέλεσε μέχρι να βρει τη θέση 7; Μπορείς να φτιάξεις ένα πρόγραμμα που θα βρίσκει τη θέση του 81 με 2 ελέγχους;

7.1.7 Γράψε ένα πρόγραμμα που μεταφέρει όλες τις τιμές από τους πίνακας1 και πίνακας2, οι οποίοι είναι ταξινομημένοι, στον πίνακας3, έτσι ώστε και ο πίνακας3 να είναι ταξινομημένος.
...
7.1.8 Γράψε ένα πρόγραμμα που εμφανίζει όλες τις τριψήφιες λέξεις που μπορούν να δημιουργηθούν από τα γράμματα Α, Β, Γ. Δηλαδή να εμφανίζει:
