...
8.1.3 Γράψε ένα πρόγραμμα που συγχωνεύει δύο ταξινομημένους πίνακες σε έναν τρίτο (ταξινομημένο).
...
8.1.4 Γράψε ένα πρόγραμμα που εμφανίζει όλες τις τριψήφιες λέξεις που μπορούν να δημιουργηθούν από τα γράμματα Α, Β, Γ. Δηλαδή να εμφανίζει:
